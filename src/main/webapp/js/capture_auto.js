...
const Capture = (function () {
	...
	return {
		...
		scanFrame: (frame) => {
			...
			const reqUrl = reqBaseUrl + "/" + ScanType.properties[ScanType.ID_AUTO].name;
			...
			$.ajax({
				...
				complete: function () {
					...
					Capture.changeRunningState(false);
				},
...
function recogState() {
	...
	if(Capture.isRunning() === false) {
		...
		Capture.changeRunningState(true);
